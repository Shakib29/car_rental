...
const MumbaiLocalBooking: React.FC = () => {
  ...
  const calculateDistance = async (origin: string, destination: string) => {
    ...
    try {
      ...
      // For now, we'll simulate the calculation with realistic Mumbai distances
      const locations = {
        'Chhatrapati Shivaji International Airport': { lat: 19.0896, lng: 72.8656 },
        ...
        'Worli': { lat: 19.0176, lng: 72.8162 },
        'Marine Drive': { lat: 18.9441, lng: 72.8238 },
        'Colaba': { lat: 18.9067, lng: 72.8147 },
        'Juhu': { lat: 19.1075, lng: 72.8263 },
        'Malad West': { lat: 19.1864, lng: 72.8493 }
      };

      const originCoords = locations[origin as keyof typeof locations];
      const destCoords = locations[destination as keyof typeof locations];
      ...
      if (originCoords && destCoords) {
        ...
        setPrice(Math.round(calculatedDistance * rate));
      }
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-2">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Popular locations: Airport, Mumbai Central, Bandra West, Andheri East
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  You can type any Mumbai location or select from popular destinations
                </p>
              </div>
            </div>
          </div>
